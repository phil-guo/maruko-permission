...
{
    public class SysOperateService : CrudAppServiceCore<MkoOperate, SysOperateDto, SearchSysOperateDto>, ISysOperateService
    {
        public SysOperateService(IObjectMapper objectMapper, ISysOperateRepos repository) : base(objectMapper, repository)
        {
        }
    }
}