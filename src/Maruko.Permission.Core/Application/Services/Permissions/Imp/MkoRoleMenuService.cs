...
{
    public class MkoRoleMenuService : CrudAppServiceCore<MkoRoleMenu, MkoRoleMenuDto, SearchMkoRoleMenuDto>, IMkoRoleMenuService
    {
        public MkoRoleMenuService(IObjectMapper objectMapper, IMkoRoleMenuRepos repository) : base(objectMapper, repository)
        {
        }
    }
}