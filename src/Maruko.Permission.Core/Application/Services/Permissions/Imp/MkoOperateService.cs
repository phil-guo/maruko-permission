...
{
    public class MkoOperateService : CrudAppServiceCore<MkoOperate, MkoOperateDto, SearchMkoOperateDto>, IMkoOperateService
    {
        public MkoOperateService(IObjectMapper objectMapper, IMkoOperateRepos repository) : base(objectMapper, repository)
        {
        }
    }
}